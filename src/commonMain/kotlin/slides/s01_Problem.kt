...
val sidecarDebugging by Slide(
    ...
    TitledSlide(title = "Side-car debugging", kicker = "// THE PROBLEM") {
        ...
        Bullet(line {
            t("Logcat, layout inspector, network profiler, etc are generic tools with no domain knowledge")
        })
        Bullet(line {
...
val wantsAndDesires by Slide(
    context = SpeakerNotes("a recomposition plugin for Flipper sounds like a nightmare"),
) {
