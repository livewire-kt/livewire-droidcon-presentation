...
val customComposition by Slide(
...
val theTree by PreparedSlide(
    stepCount = 4,
    context = SpeakerNotes(
        listOf(
            0..0 to "If we hearken back to our data structures class. A tree is essentially just " +
            ...
            3..3 to "Then we define its first concrete implementation, the `RootNode`. Which is " +
...
val applier by PreparedSlide(
    stepCount = 3,
    context = SpeakerNotes(
        listOf(
            0..0 to "Next! We need an applier, or a way to tell Compose how to manipulate our " +
                "tree.\n\n" +
            ...
            1..1 to "The first methods in an applier are how it inserts nodes into your tree. " +
            ...
            2..2 to "Lastly, are just the remaining tree manipulation methods for removing, " +
...
val composition by PreparedSlide(
    stepCount = 5,
    context = SpeakerNotes(
        listOf(
            0..0 to "Next, is building the Composition. This example is simplified for brevity of " +
            ...
            3..3 to "Next, we create the Recomposer object so we can power recompositions in our " +
                "custom composition. (*go check out those other talks for more on this*)",
            4..4 to "Lastly, we create our Composition, run the recomposer, and give it the " +
